...
**Внимание: если вы используете HAProxy и проверку /primary от Patroni, то при отказе всех etcd вам необходимо сделать дополнительный failover секцию на read-only.**